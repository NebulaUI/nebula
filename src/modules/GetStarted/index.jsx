...
const GetStarted = ({ history }) => (
  <Section size="md">
    <SiteWrap padding>
      <h1><span style={{ verticalAlign: 'middle' }}>Get started with</span> <img src={`/src/assets/img/nebula-logo.svg`} style={{ maxWidth: '150px', height: 'auto', verticalAlign: 'middle' }} /></h1>
